package com.ohgiraffers.secotion03.stringbuilder;
...
public class Application02 {
    public static void main(String[] args) {
         ...
         * 둘 다 원본에 영향을 미친다.
         * */
        System.out.println("delete() : " + sb2.delete(2, 5)); //jaracle  마지막인덱스는 제거안댐.
        System.out.println("deleteCharAt() : " + sb2.deleteCharAt(0)); //aracle 한글자만 지울수잇다.
